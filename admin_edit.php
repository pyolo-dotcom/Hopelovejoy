...
$return_tab = isset($_GET['tab']) ? $_GET['tab'] : 'past_sales'; // Get the tab to return to
...
<head>
    ...
    <title>Edit Sale - Hope Account Specialist</title>
...
<body>
    <div class="edit-container">
        ...
        <div class="current-image-section">
            ...
            <div class="image-preview-container">
                <img src="<?php echo $sale['image_path']; ?>" 
                     ...
                     class="current-image"
                     onerror="this.src='https://via.placeholder.com/280x200/1A1A1A/FFD700?text=No+Image'">
            </div>
        ...
        <!-- Edit Form -->
        <form method="POST" action="admin_save.php?tab=<?php echo $return_tab; ?>" enctype="multipart/form-data" class="edit-form">
            ...
            <div class="form-grid">
                <div class="form-group">
                    <label for="title">
                        <i class="fas fa-heading"></i> Title <span style="color: var(--gold-primary);">*</span>
                    </label>
                    <input type="text" id="title" name="title" class="form-control" 
                           value="<?php echo htmlspecialchars($sale['title']); ?>" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select id="category" name="category" class="form-control" required>
                        ...
                        <option value="land" <?php echo $sale['category'] == 'land' ? 'selected' : ''; ?>>🏞️ Land</option>
            ...
            <div class="form-grid">
                <div class="form-group">
                    <label for="sale_date">
                        <i class="fas fa-calendar-alt"></i> Sale Date <span style="color: var(--gold-primary);">*</span>
                    </label>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="price" name="price" step="0.01" class="form-control"
                           value="<?php echo $sale['price']; ?>" placeholder="0.00">
                    <div class="helper-text">
                        <i class="fas fa-info-circle"></i> Leave empty if price is confidential
                    </div>
                </div>
            </div>
            ...
            <div class="form-group full-width">
                ...
                <textarea id="description" name="description" class="form-control" 
                          placeholder="Describe the sale details..."><?php echo htmlspecialchars($sale['description']); ?></textarea>
            </div>
            
            <div class="form-group full-width">
                <label for="image">
                    <i class="fas fa-cloud-upload-alt"></i> New Image (Optional)
                </label>
                <input type="file" id="image" name="image" accept="image/*" class="form-control">
                <div class="helper-text">
                    <i class="fas fa-info-circle"></i> Max size: 5MB. Supported formats: JPG, PNG, GIF. Leave empty to keep current image.
                </div>
            </div>
            ...
            <div class="form-group full-width">
                ...
                <div class="status-toggle">
                    <label class="status-option <?php echo $sale['is_active'] ? 'active-option' : ''; ?>">
                        <input type="radio" name="is_active" value="1" <?php echo $sale['is_active'] ? 'checked' : ''; ?>>
                        <span class="status-badge-demo active">
                            <i class="fas fa-check-circle"></i> Active
                        </span>
                        <span style="color: var(--text-muted); font-size: 0.85rem;">Display on website</span>
                    </label>
                    <label class="status-option <?php echo !$sale['is_active'] ? 'inactive-option' : ''; ?>">
                        <input type="radio" name="is_active" value="0" <?php echo !$sale['is_active'] ? 'checked' : ''; ?>>
            ...
            <div class="form-actions">
                ...
                <a href="?tab=<?php echo $return_tab; ?>&delete=<?php echo $sale['id']; ?>" 
                   class="btn btn-danger" 
                   onclick="return confirmDelete()">
                    <i class="fas fa-trash-alt"></i> Delete Sale
                </a>
            </div>
        </form>
    </div>
    ...
    <script>
        ...
        // Image preview on file select (optional enhancement)
        ...
        // Prevent accidental form submission on Enter key in textareas
        const textareas = document.querySelectorAll('textarea');
        textareas.forEach(textarea => {
            textarea.addEventListener('keydown', function(e) {
                if (e.key === 'Enter' && !e.shiftKey) {
                    // Allow normal Enter behavior for new lines
                    // Do not prevent default - allows proper textarea behavior
                }
            });
        });

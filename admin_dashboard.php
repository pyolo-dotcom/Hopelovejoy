...
<head>
    ...
    <style>
        ...
        * {
        ...
        .stats-badge .new-count {
            color: var(--gold-primary);
            font-weight: 700;
            font-size: 1.1rem;
        }
        
        .stats-badge .read-count {
...
<body>
    ...
    <div class="admin-container">
        ...
        <!-- Past Sales Tab -->
        <div id="past_sales" class="tab-content" style="<?php echo $active_tab != 'past_sales' ? 'display: none;' : ''; ?>">
                     ...
                     <table>
                        ...
                        <tbody>
                            <?php if (mysqli_num_rows($past_sales_result) > 0): ?>
                                <?php 
                                mysqli_data_seek($past_sales_result, 0);
                                while ($row = mysqli_fetch_assoc($past_sales_result)): 
                                ?>
                                 <tr>
                                     ...
                                     <td>
                                        <div class="action-buttons-modern">
                                            <a href="admin_edit.php?id=<?php echo $row['id']; ?>&tab=<?php echo $active_tab; ?>" class="btn-modern btn-edit-modern">
                                                <i class="fas fa-edit"></i> Edit
                                            </a>
                                            <a href="#" data-href="?tab=past_sales&delete=<?php echo $row['id']; ?>" class="btn-modern btn-delete-modern delete-btn">
        ...
        <div id="affiliated_houses" class="tab-content" style="<?php echo $active_tab != 'affiliated_houses' ? 'display: none;' : ''; ?>">
            <div class="modern-table">
                <div class="table-header-modern">
                    ...
                    <table>
                        ...
                        <tbody>
                            <?php if (mysqli_num_rows($affiliated_houses_result) > 0): ?>
                                <?php 
                                mysqli_data_seek($affiliated_houses_result, 0);
                                while ($affiliated = mysqli_fetch_assoc($affiliated_houses_result)): 
                                ?>
                                 <tr>
                                    ...
                                    <td style="color: var(--gold-primary);"><?php echo $affiliated['display_order']; ?></td>
                                     ...
                                     <td>
                                        <div class="action-buttons-modern">
                                            <a href="admin_edit_affiliated.php?id=<?php echo $affiliated['id']; ?>&tab=<?php echo $active_tab; ?>" class="btn-modern btn-edit-modern">
                                                <i class="fas fa-edit"></i> Edit
                                            </a>
                                            <a href="#" data-href="?tab=affiliated_houses&delete=<?php echo $affiliated['id']; ?>" class="btn-modern btn-delete-modern delete-btn">
                                                <i class="fas fa-trash"></i> Delete
                                            </a>
                                        </div>
                                     </td>
        ...
        <div id="affiliated_banks" class="tab-content" style="<?php echo $active_tab != 'affiliated_banks' ? 'display: none;' : ''; ?>">
            <div class="modern-table">
                <div class="table-header-modern">
                    ...
                    <table>
                        ...
                        <tbody>
                            <?php if (mysqli_num_rows($affiliated_banks_result) > 0): ?>
                                <?php 
                                mysqli_data_seek($affiliated_banks_result, 0);
                                while ($bank = mysqli_fetch_assoc($affiliated_banks_result)): 
                                ?>
                                 <tr>
                                    ...
                                    <td style="color: var(--gold-primary);"><?php echo $bank['display_order']; ?></td>
                                     ...
                                     <td>
                                        <div class="action-buttons-modern">
                                            <a href="admin_edit_bank.php?id=<?php echo $bank['id']; ?>&tab=<?php echo $active_tab; ?>" class="btn-modern btn-edit-modern">
                                                <i class="fas fa-edit"></i> Edit
                                            </a>
                                            <a href="#" data-href="?tab=affiliated_banks&delete=<?php echo $bank['id']; ?>" class="btn-modern btn-delete-modern delete-btn">
                                                <i class="fas fa-trash"></i> Delete
                                            </a>
                                        </div>
                                     </td>
        ...
        <!-- Affiliated Cars Tab -->
        <div id="affiliated_cars" class="tab-content" style="<?php echo $active_tab != 'affiliated_cars' ? 'display: none;' : ''; ?>">
            <div class="modern-table">
                <div class="table-header-modern">
                    ...
                    <table>
                        ...
                        <tbody>
                            <?php if (mysqli_num_rows($affiliated_cars_result) > 0): ?>
                                <?php 
                                mysqli_data_seek($affiliated_cars_result, 0);
                                while ($car = mysqli_fetch_assoc($affiliated_cars_result)): 
                                ?>
                                 <tr>
                                    ...
                                    <td style="color: var(--gold-primary);"><?php echo $car['display_order']; ?></td>
                                     ...
                                     <td>
                                        <div class="action-buttons-modern">
                                            <a href="admin_edit_car.php?id=<?php echo $car['id']; ?>&tab=<?php echo $active_tab; ?>" class="btn-modern btn-edit-modern">
                                                <i class="fas fa-edit"></i> Edit
                                            </a>
                                            <a href="#" data-href="?tab=affiliated_cars&delete=<?php echo $car['id']; ?>" class="btn-modern btn-delete-modern delete-btn">
                                                <i class="fas fa-trash"></i> Delete
                                            </a>
                                        </div>
                                     </td>
        ...
        <!-- Team Members Tab -->
        <div id="team_members" class="tab-content" style="<?php echo $active_tab != 'team_members' ? 'display: none;' : ''; ?>">
            <div class="modern-table">
                <div class="table-header-modern">
                            ...
                            if (mysqli_num_rows($team_members_result) > 0): ?>
                                <?php while ($member = mysqli_fetch_assoc($team_members_result)): ?>
                                 <tr>
                                    ...
                                    <td>
                                        <div class="action-buttons-modern">
                                            <a href="admin_edit_team.php?id=<?php echo $member['id']; ?>&tab=<?php echo $active_tab; ?>" class="btn-modern btn-edit-modern">
                                                <i class="fas fa-edit"></i> Edit
                                            </a>
                                            <a href="#" data-href="?tab=team_members&delete=<?php echo $member['id']; ?>" class="btn-modern btn-delete-modern delete-btn">
                                                <i class="fas fa-trash"></i> Delete
                                            </a>
                                        </div>
                                    </td>
        ...
        <!-- Awards Tab -->
        <div id="awards" class="tab-content" style="<?php echo $active_tab != 'awards' ? 'display: none;' : ''; ?>">
            <div class="modern-table">
                <div class="table-header-modern">
                        ...
                        <tbody>
                            <?php if (mysqli_num_rows($awards_result) > 0): ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="action-buttons-modern">
                                            <a href="admin_edit_award.php?id=<?php echo $award['id']; ?>&tab=<?php echo $active_tab; ?>" class="btn-modern btn-edit-modern">
                                                <i class="fas fa-edit"></i> Edit
                                            </a>
                                            <a href="#" data-href="?tab=awards&delete=<?php echo $award['id']; ?>" class="btn-modern btn-delete-modern delete-btn">
                                                <i class="fas fa-trash"></i> Delete
                                            </a>
                                        </div>
                                    </td>
        ...
        <!-- ========== CONTACT MESSAGES TAB - FULLY ALIGNED ========== -->
        <div id="contact_messages" class="tab-content" style="<?php echo $active_tab != 'contact_messages' ? 'display: none;' : ''; ?>">
            <div class="modern-table">
                <div class="table-header-modern">
                    <h2><i class="fas fa-envelope"></i> Contact Messages</h2>
                    <div class="stats-badge-group">
                        <div class="stats-badge">
                            <i class="fas fa-circle" style="color: var(--gold-primary); font-size: 0.7rem;"></i>
                            <span>New: <span class="new-count" id="newCount"><?php echo $new_count; ?></span></span>
                        </div>
                        <div class="stats-badge">
                            <i class="fas fa-circle" style="color: var(--success-color); font-size: 0.7rem;"></i>
                            <span>Read: <span class="read-count" id="readCount"><?php echo $read_count; ?></span></span>
                        </div>
                    </div>
                </div>
                
                <?php 
                // Fetch messages with new first, then by date
                    ...
                    <table>
                        ...
                        <tbody>
                            <?php if (mysqli_num_rows($messages_result) > 0): ?>
                                ...
                                <tr data-message-id="<?php echo $msg['id']; ?>" class="message-row">
                                    <td><strong>#<?php echo str_pad($msg['id'], 4, '0', STR_PAD_LEFT); ?></strong></td>
                                    <td>
                                        <div class="contact-info-modern">
                                            <div class="contact-name"><?php echo htmlspecialchars($msg['name']); ?></div>
                                            <div class="contact-email"><a href="mailto:<?php echo htmlspecialchars($msg['email']); ?>"><i class="fas fa-envelope"></i> <?php echo htmlspecialchars($msg['email']); ?></a></div>
                                            <?php if (!empty($msg['phone'])): ?>
                                            <div class="contact-phone"><a href="tel:<?php echo htmlspecialchars($msg['phone']); ?>"><i class="fas fa-phone-alt"></i> <?php echo htmlspecialchars($msg['phone']); ?></a></div>
                                            <?php endif; ?>
                                        </div>
                                    </td>
                                    <td><span class="category-tag"><?php echo htmlspecialchars($msg['service'] ?: 'General Inquiry'); ?></span></td>
                                    <td>
                                        <div class="message-preview-modern" onclick="viewMessage(<?php echo $msg['id']; ?>)">
                                            <div class="message-preview-content"><?php echo htmlspecialchars(substr($msg['message'], 0, 100)) . (strlen($msg['message']) > 100 ? '...' : ''); ?></div>
                                        </div>
                                    </td>
                                    <td class="date-time-col">
                                        <div class="date-main"><?php echo date('M d, Y', strtotime($msg['created_at'])); ?></div>
                                        <div class="date-sub"><?php echo date('h:i A', strtotime($msg['created_at'])); ?></div>
                                    </td>
                                    <td>
                                        <?php if ($msg['status'] == 'new'): ?>
                                            <span class="status-badge status-new"><i class="fas fa-clock"></i> New</span>
                                        <?php else: ?>
                                            <span class="status-badge status-read"><i class="fas fa-check-circle"></i> Read</span>
                                        <?php endif; ?>
                                    </td>
                                    <td>
                                        <div class="action-buttons-modern">
                                            <button onclick="viewMessage(<?php echo $msg['id']; ?>)" class="btn-modern" style="background: var(--gold-gradient); color: var(--black-dark);">
                                                <i class="fas fa-eye"></i> View
                                            </button>
                                            <a href="mailto:<?php echo htmlspecialchars($msg['email']); ?>?subject=Re: Your inquiry about <?php echo urlencode($msg['service'] ?: 'our services'); ?>" class="btn-modern btn-edit-modern" target="_blank">
                                                <i class="fas fa-reply"></i> Reply
                                            </a>
                                            <a href="#" data-href="?tab=contact_messages&delete=<?php echo $msg['id']; ?>" class="btn-modern btn-delete-modern delete-btn">
                                                <i class="fas fa-trash"></i> Delete
                                            </a>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td colspan="7">
                                        <div class="empty-state-modern">
                                            ...
                                            <p>Contact form submissions will appear here. Check back later for new messages.</p>
                                        </div>
                                    </td>
                                </tr>
                            <?php endif; ?>
                ...
                <div class="table-footer-actions">
                    <div style="color: var(--text-muted); font-size: 0.85rem;">
                        <i class="fas fa-database"></i> <?php echo mysqli_num_rows($messages_result); ?> message(s) total
                    </div>
        ...
        <div class="modal-content-modern">
            ...
            <div class="modal-body" id="modalMessageContent">
                <div style="text-align: center; padding: 40px;">
                    ...
                    <p style="margin-top: 20px;">Loading message...</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function viewMessage(messageId) {
            ...
            contentDiv.innerHTML = '<div style="text-align:center;padding:40px;"><i class="fas fa-spinner fa-spin" style="font-size:2rem;color:var(--gold-primary);"></i><p style="margin-top:20px;">Loading message details...</p></div>';
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        contentDiv.innerHTML = `
                            <div style="background: var(--gold-gradient); color: var(--black-dark); padding: 20px; border-radius: var(--radius); margin-bottom: 20px;">
                                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px;">
                                    ...
                                    <span style="background: ${msg.status == 'new' ? 'var(--gold-primary)' : 'var(--black-dark)'}; color: ${msg.status == 'new' ? 'var(--black-dark)' : 'var(--gold-primary)'}; padding: 6px 15px; border-radius: 20px; font-size: 0.85rem; font-weight: 600;">
                                        <i class="fas fa-${msg.status == 'new' ? 'clock' : 'check-circle'}"></i>
                                ...
                                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 15px;">
                                    <div>
                                        ...
                                        <div style="font-size: 1rem;">
                                            <a href="mailto:${escapeHtml(msg.email)}" style="color: var(--black-dark); text-decoration: none; font-weight: 600;">
                                    ...
                                    <div>
                                        ...
                                        <div style="font-size: 1rem;">
                                            ${msg.phone ? `<a href="tel:${escapeHtml(msg.phone)}" style="color: var(--black-dark); text-decoration: none; font-weight: 600;">${escapeHtml(msg.phone)}</a>` : '<span style="color: rgba(0,0,0,0.6);">Not provided</span>'}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div style="display: flex; align-items: center; gap: 10px;">
                                    ...
                                    <div>
                                        ...
                                        <div style="font-size: 1.1rem; font-weight: 600; color: var(--gold-primary);">
                                            ${escapeHtml(msg.service || 'General Inquiry')}
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div style="margin-bottom: 30px;">
                                <h4 style="color: var(--gold-primary); margin-bottom: 15px; padding-bottom: 10px; border-bottom: 2px solid var(--gold-dark); display: flex; align-items: center; gap: 10px;">
                                    <i class="fas fa-comment-dots"></i>
                                    Message Content
                                </h4>
                                <div style="background: var(--black-soft); padding: 20px; border-radius: var(--radius); line-height: 1.6; white-space: pre-wrap; font-size: 1rem; color: var(--text-light); max-height: 300px; overflow-y: auto; border: 1px solid var(--gold-dark);">
                                    ${escapeHtml(msg.message).replace(/\n/g, '<br>')}
                                </div>
                            </div>
                            
                            <div style="display: flex; gap: 12px; justify-content: flex-end; border-top: var(--border-gold); padding-top: 20px;">
                                <a href="mailto:${escapeHtml(msg.email)}?subject=Re: Your inquiry about ${escapeHtml(msg.service || 'our services')}" class="admin-btn" target="_blank">
                                    <i class="fas fa-reply"></i> Reply
                                </a>
                                <a href="?tab=contact_messages&delete=${msg.id}" class="admin-btn" style="background: linear-gradient(135deg, #FF4444 0%, #CC0000 100%); color: white;" onclick="return confirm('Are you sure you want to delete this message?')">
                                    <i class="fas fa-trash"></i> Delete
                                </a>

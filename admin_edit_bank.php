...
<head>
    ...
    <title>Edit Bank - Admin Panel</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <link rel="icon" type="image/png" href="img/logo.png">
    <style>
        /* Use same styles as admin_edit_affiliated.php */
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="edit-container">
        <div class="edit-header">
            <h1><i class="fas fa-edit"></i> Edit Bank</h1>
        ...
        <form method="POST" action="admin_save_bank.php" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="name"><i class="fas fa-university"></i> Bank Name *</label>
                <input type="text" id="name" name="name" value="<?php echo htmlspecialchars($bank['name']); ?>" required>
            </div>
            
            <div class="form-group">
                <label for="display_order"><i class="fas fa-sort-numeric-up"></i> Display Order</label>
                <input type="number" id="display_order" name="display_order"
                       value="<?php echo $bank['display_order']; ?>">
            ...
            <div class="form-group">
                ...
                <select id="is_active" name="is_active">
                    <option value="1" <?php echo $bank['is_active'] ? 'selected' : ''; ?>>Active</option>
                    <option value="0" <?php echo !$bank['is_active'] ? 'selected' : ''; ?>>Inactive</option>
                </select>
            </div>
